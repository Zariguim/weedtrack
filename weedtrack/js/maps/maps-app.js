...
const MapasApp = {
    ...
    bindEvents() {
        ...
        this.dom.drawKmlBtn.addEventListener('click', this.startKmlDrawing.bind(this));
    ...
    async loadKmlDatabase() {
        ...
        // ADICIONADO PARA DEBUG: Verifique o console do navegador (F12) para ver essas mensagens
    ...
    async handleKmlUpload() {
        ...
        reader.onerror = () => {
            UIManager.showToast('Erro ao ler o ficheiro KML.', 'error');
        };
    ...
    handleGenerateClick() {
        ...
        if (!this.state.kmlGeoJSON) { UIManager.showToast('Por favor, carregue um ficheiro KML primeiro.', 'error'); return; }
    ...
    handleNewKmlDrawn(event) {
        ...
        const url = URL.createObjectURL(blob);
        this.processKml(url);
        UIManager.showToast('Talhão desenhado com sucesso!', 'info');
    },
