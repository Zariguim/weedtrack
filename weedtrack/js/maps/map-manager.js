...
const MapManager = {
    ...
    reportControl: null, // Novo controle para o botão de relatório
    ...
    initCustomControls() {
        ...
        this.reportControl = new L.Control.ButtonPlaceholder({ position: 'topright' }).addTo(this.map); // Adicionado
    ...
    clearAllMapLayers() {
        ...
        this.reportControl.getContainer().innerHTML = ''; // Adicionado
